...
/* package agario-0.1.0.0 */
#ifndef VERSION_agario
#define VERSION_agario "0.1.0.0"
#endif /* VERSION_agario */
#ifndef MIN_VERSION_agario
#define MIN_VERSION_agario(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_agario */
...
#define CURRENT_COMPONENT_ID "agario-0.1.0.0-inplace-agario"
